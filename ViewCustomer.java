...
public class ViewCustomer extends JFrame implements ActionListener{
    ...
    ViewCustomer(String username){
        ...
        l7.setBounds(500,110,100,25);
        add(l7);     
        
        JLabel l17=new JLabel();
        l17.setBounds(650,110,150,25);
        add(l17);
        
        JLabel l8=new JLabel("Phone : ");
        l8.setBounds(500,170,100,25);
        add(l8);     
        ...
        l9.setBounds(500,230,100,25);
        add(l9);     
        
        JLabel l19=new JLabel();
        l19.setBounds(650,230,180,25);
        add(l19);
        ...
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("TourismManagementsystem/icons/viewall.jpg"));
        Image i2=i1.getImage().getScaledInstance(600,200,Image.SCALE_DEFAULT);
        ImageIcon i3= new ImageIcon(i2);
        JLabel l10=new JLabel(i3);
        l10.setBounds(0,390,600,200);
        add(l10);
        
        ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("TourismManagementsystem/icons/viewall.jpg"));
        Image i5=i4.getImage().getScaledInstance(600,200,Image.SCALE_DEFAULT);
        ImageIcon i6= new ImageIcon(i5);
        JLabel l20=new JLabel(i6);
        l20.setBounds(585,390,600,200);
        add(l20);
